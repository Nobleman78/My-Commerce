...
const Login = () => {
    ...
    const handleLoginSuccess = async()=>{
        ...
        /* If location.state?.from exists → use that path
           If location.state?.from is missing/undefined → defaults to /cart
        */
        ...
        <div>
            <form onSubmit={handleLogin} className='shadow-2xl rounded-xl w-[90%] h-[400px] px-5 py-5 sm:max-w-96 m-auto mt-14 text-gray-800' >
                ...
                <div className="flex flex-col gap-1 ">
                    ...
                    {
                        success && <p className='text-green-500'> Login Succesful</p>
                    }
                    {
